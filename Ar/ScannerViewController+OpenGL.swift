...
extension ScannerViewController {
    ...
    func setupGLViewport() {
        ...
        if !framebufferAspectRatio.nearlyEqual(b: vgaAspectRatio) {
    ...
    func renderSceneForDepthFrame(depthFrame: STDepthFrame, colorFrame: STColorFrame?) {
        ...
        case .CubePlacement:
            ...
            if _slamState.cameraPoseInitializer!.hasValidPose {
                ...
                if _useColorCamera {
                    ...
                    withUnsafeMutablePointer(to: &colorCameraPoseInStreamCoordinateSpace, {depthFrame.colorCameraPose(inDepthCoordinateFrame: UnsafeMutableRawPointer($0).assumingMemoryBound(to: Float.self))})
        ...
        case .Scanning:
            ...
            if _useColorCamera && !_options.useHardwareRegisteredDepth {
                ...
                withUnsafeMutablePointer(to: &colorCameraPoseInDepthCoordinateSpace, {depthFrame.colorCameraPose(inDepthCoordinateFrame: UnsafeMutableRawPointer($0).assumingMemoryBound(to: Float.self))})
