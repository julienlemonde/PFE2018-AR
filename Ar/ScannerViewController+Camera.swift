 ...
 extension ScannerViewController: AVCaptureVideoDataOutputSampleBufferDelegate {
	...
	func setupColorCamera() {
		...
		do {
            ...
            self.selectCaptureFormat(demandFormat: ["width": imageWidth, "height": imageHeight])
            ...
            setLensPositionWithValue(value: Float(_options.lensPosition), lockVideoDevice: false)
