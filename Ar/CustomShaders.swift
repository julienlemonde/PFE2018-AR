...
class LightedGrayShader: CustomShader {
    ...
    override func load()
    {
        ...
        glProgram = loadOpenGLProgramFromString(vertex_shader_src: vertexShaderSource(), fragment_shader_src: fragmentShaderSource(), num_attributes: NUM_ATTRIBS, attribute_ids: attributeIds, attribute_names: attributeNames)
...
func loadOpenGLProgramFromString(vertex_shader_src : NSString, fragment_shader_src : NSString, num_attributes : Int, attribute_ids: [GLuint], attribute_names : [String]) -> GLuint {
    ...
    vertex_shader = loadOpenGLShaderFromString( type: GLenum(GL_VERTEX_SHADER), shaderSrc: vertex_shader_src)
    ...
    //NSLog("Shader -> %@\n", vertex_shader_src)
    fragment_shader = loadOpenGLShaderFromString( type: GLenum(GL_FRAGMENT_SHADER), shaderSrc: fragment_shader_src)
